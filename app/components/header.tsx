...
export function Header({
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur-sm">
      <div className="grid grid-cols-[auto_1fr_auto] items-center gap-2 px-4 py-4 sm:px-6">
        <Link href={rootHref} className="ml-2 flex flex-col items-start sm:ml-4">
      ...
      {bottomSlot ? (
        <div className="border-t border-border bg-surface-alt px-4 py-3 text-sm text-muted">
          {bottomSlot}
        </div>
      ) : null}
    </header>
